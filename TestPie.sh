...
mm-delay $1 mm-link $2 $2 --uplink-queue=pie --downlink-queue=infinite --uplink-queue-args="packets=1000000, qdelay_ref=$4, max_burst=1" ./start.sh $3 #xterm -e "cd ../rl-qm/mahimahiSocketInterfaceSingleLoop; python RLMahimahiInterface.py 100.64.0.4" &
