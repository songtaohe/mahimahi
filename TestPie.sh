...
mm-delay $1 mm-link $2 $3 --uplink-queue=pie --downlink-queue=infinite --uplink-queue-args="packets=200, qdelay_ref=$5, max_burst=1" --uplink-log=$6 --meter-uplink ./start2L.sh $4 #xterm -e "cd ../rl-qm/mahimahiSocketInterfaceSingleLoop; python RLMahimahiInterface.py 100.64.0.4" &
